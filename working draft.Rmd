...
# read in income file
incomes <- read.csv(file="C:/Users/Ashley Hirt/Documents/GitHub/FinalProject/zipcodes - Sheet1.csv")
...
write.csv(data.frame("x"=sort(unique(hosp$CCS.Code))), file="C:/Users/Ashley Hirt/Documents/GitHub/FinalProject/ccscodes.csv", row.names=F)
